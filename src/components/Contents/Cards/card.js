...
export default function Card({ foodList, state, setState }) {
  ...
  if (state === "all") foodCate = foodList;
  if (state === "popular") {
  ...
  return (
    <>
      <div className="flex flex-row flex-wrap space-x-4 justify-between pt-14 items-center ">
        <h3 className="basis-1/8 m-auto textfont-medium text-lg text-center md:text-left text-xl md:ml-44 flex items-center ">
          {" "}
          Popular foods
        </h3>
        ...
        <div className="flex basis-1/8 hidden md:flex">
          <a
            className="cursor-pointer mr-44 whitespace-nowrap w-36 inline-flex items-center justify-center px-2 py-1
      ...
      <div className="pt-20 flex flex-col lg:flex-row flex-wrap gap-x-8 gap-y-20 justify-center items-center">
        {foodCate.map((food) => (
          <div
            key={food.id}
            class="basis-1/5 rounded-lg flex flex-col xl:flex-row items-center justify-center bg-gray-100 
          ...
          >
            <img
              className="w-32 pb-64 rounded-t-lg absolute"
              src={food.image}
              alt="product"
            />
            ...
            <div className="px-5 pb-5 pt-20 ">
              ...
              <div className="flex justify-between items-center">
                ...
                {checkInCart(food.name) && <AddButton></AddButton> ? (
